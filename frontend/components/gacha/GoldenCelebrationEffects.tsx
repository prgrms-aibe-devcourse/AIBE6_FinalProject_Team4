    ...
    >
      ...
      <div className="absolute inset-x-0 top-[10%] flex justify-center sm:top-[12%]">
        <div className="relative text-center motion-safe:animate-goldenFanfareTitle">
          <p className="flex items-center justify-center gap-1.5 text-[10px] font-black tracking-[0.55em] text-[#fff2a7] drop-shadow-[0_0_12px_rgba(255,218,82,.9)] sm:text-xs">
