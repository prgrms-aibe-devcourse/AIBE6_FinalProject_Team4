...
public record PlantCareEvidence(
    String sourceId, String sourceName, String version, String content) {

  public PlantCareEvidence {
    if (blank(sourceId) || blank(sourceName) || blank(version) || blank(content)) {
      throw new IllegalArgumentException("재배 근거의 식별자, 이름, 버전, 내용이 필요합니다.");
    }
  }
