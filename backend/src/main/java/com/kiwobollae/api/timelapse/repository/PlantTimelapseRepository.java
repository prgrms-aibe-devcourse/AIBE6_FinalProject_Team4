package com.kiwobollae.api.timelapse.repository;
...
public interface PlantTimelapseRepository extends JpaRepository<PlantTimelapse, Long> {
	...
	@Modifying
	@Query("update PlantTimelapse t set t.status = com.kiwobollae.api.timelapse.entity.enums.PlantTimelapseStatus.PROCESSING "
			+ "where t.plantProfile.id = :profileId "
			+ "and t.status = com.kiwobollae.api.timelapse.entity.enums.PlantTimelapseStatus.PENDING")
	...
	@Modifying
	@Query("update PlantTimelapse t set t.status = com.kiwobollae.api.timelapse.entity.enums.PlantTimelapseStatus.FAILED, "
			+ "t.failReason = :reason, t.completedAt = :completedAt "
			+ "where t.plantProfile.id = :profileId "
			+ "and t.status in (com.kiwobollae.api.timelapse.entity.enums.PlantTimelapseStatus.PENDING, "
			+ "com.kiwobollae.api.timelapse.entity.enums.PlantTimelapseStatus.PROCESSING)")
	...
	@Query("select t.plantProfile.id from PlantTimelapse t "
			+ "where t.status in (com.kiwobollae.api.timelapse.entity.enums.PlantTimelapseStatus.PENDING, "
			+ "com.kiwobollae.api.timelapse.entity.enums.PlantTimelapseStatus.PROCESSING) "
